...
import styles from './SubjectScheduleListView.module.css';

interface SubjectScheduleListViewProps {
...
export function SubjectScheduleListView({
  entries,
  activeDays,
}: SubjectScheduleListViewProps) {
                ...
                >
                  ...
                  <div className={styles.cardBody}>
                    ...
                    <div className={styles.cardMeta}>
                      ...
                      <span>{entry.majors.join(' · ')}</span>
                    </div>
                    <p className={styles.cardProfessor}>
                      {entry.professor}
                    </p>
                  </div>
