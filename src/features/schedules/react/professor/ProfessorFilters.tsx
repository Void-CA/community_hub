import type { ProfessorFiltersProps } from '../shared/types';
import styles from './ProfessorFilters.module.css';
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={`${styles.section} ${styles.flex1}`}>
          <span className={styles.hint}>Docente Activo</span>
          <p className={styles.profName}>{professorName || 'Sin selección'}</p>
        </div>
